...
class PigeonInstanceManager {
  ...
  static PigeonInstanceManager _initInstance() {
    ...
    Auth.pigeon_setUpMessageHandlers(pigeon_instanceManager: instanceManager);
    Credentials.pigeon_setUpMessageHandlers(pigeon_instanceManager: instanceManager);
  ...
  }) {
    {
      ...
      if (pigeon_clearHandlers) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.com.example.proxy_bug_report.PigeonInternalInstanceManager.removeStrongReference was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_identifier = (args[0] as int?);
          assert(arg_identifier != null,
              'Argument for dev.flutter.pigeon.com.example.proxy_bug_report.PigeonInternalInstanceManager.removeStrongReference was null, expected non-null int.');
          try {
...
class Auth extends PigeonInternalProxyApiBaseClass {
  factory Auth({
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
  }) {
    if (PigeonOverrides.auth_new != null) {
      return PigeonOverrides.auth_new!();
    }
    return Auth.pigeon_new(
  ...
  /// Constructs [Auth] without creating the associated native object.
  ///
  /// This should only be used by subclasses created by this library or to
  /// create copies for an [PigeonInstanceManager].
  @protected
  Auth.pigeon_detached({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
  });

  late final _PigeonInternalProxyApiBaseCodec _pigeonVar_codecAuth =
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    Auth Function()? pigeon_newInstance,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
    ...
    final BinaryMessenger? binaryMessenger = pigeon_binaryMessenger;
    {
      final BasicMessageChannel<
          Object?> pigeonVar_channel = BasicMessageChannel<
              Object?>(
          'dev.flutter.pigeon.com.example.proxy_bug_report.Auth.pigeon_newInstance',
          pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (pigeon_clearHandlers) {
        pigeonVar_channel.setMessageHandler(null);
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.com.example.proxy_bug_report.Auth.pigeon_newInstance was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_pigeon_instanceIdentifier = (args[0] as int?);
          assert(arg_pigeon_instanceIdentifier != null,
              'Argument for dev.flutter.pigeon.com.example.proxy_bug_report.Auth.pigeon_newInstance was null, expected non-null int.');
          try {
            (pigeon_instanceManager ?? PigeonInstanceManager.instance)
  ...
  Future<Credentials> getCredentials() async {
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as Credentials?)!;
    }
  }

  @override
  Auth pigeon_copy() {
    return Auth.pigeon_detached(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
    );
  }
...
class Credentials extends PigeonInternalProxyApiBaseClass {
  /// Constructs [Credentials] without creating the associated native object.
  ///
  /// This should only be used by subclasses created by this library or to
  /// create copies for an [PigeonInstanceManager].
  @protected
  Credentials.pigeon_detached({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    Credentials Function(String accessToken)? pigeon_newInstance,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _PigeonInternalProxyApiBaseCodec(
            pigeon_instanceManager ?? PigeonInstanceManager.instance);
    final BinaryMessenger? binaryMessenger = pigeon_binaryMessenger;
    {
      ...
      if (pigeon_clearHandlers) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(message != null,
              'Argument for dev.flutter.pigeon.com.example.proxy_bug_report.Credentials.pigeon_newInstance was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_pigeon_instanceIdentifier = (args[0] as int?);
          assert(arg_pigeon_instanceIdentifier != null,
              'Argument for dev.flutter.pigeon.com.example.proxy_bug_report.Credentials.pigeon_newInstance was null, expected non-null int.');
          final String? arg_accessToken = (args[1] as String?);
          assert(arg_accessToken != null,
              'Argument for dev.flutter.pigeon.com.example.proxy_bug_report.Credentials.pigeon_newInstance was null, expected non-null String.');
          try {
            (pigeon_instanceManager ?? PigeonInstanceManager.instance)
                .addHostCreatedInstance(
              pigeon_newInstance?.call(arg_accessToken!) ??
                  Credentials.pigeon_detached(
                    pigeon_binaryMessenger: pigeon_binaryMessenger,
                    pigeon_instanceManager: pigeon_instanceManager,
  ...
  @override
  Credentials pigeon_copy() {
    return Credentials.pigeon_detached(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
